...
const budgetControllers = {
  ...
  addBudget: async (req, res) => {
    try {
      const { name, moneyLimit, moneySpend, walletIds, category, startDate, finishDate, color, userId } = req.body;
      const budgetData = { name, moneyLimit, moneySpend, walletIds, category, startDate, finishDate, color, userId };
