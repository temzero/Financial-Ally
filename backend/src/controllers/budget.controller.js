...
const budgetControllers = {
  ...
  updateBudget: async (req, res) => {
    try {
      const { name, moneyLimit, moneySpend, wallets, category, startDate, finishDate, color } = req.body;
      const budgetId = req.params.budgetId;
      const budgetUpdateData = { name, moneyLimit, moneySpend, wallets, category, startDate, finishDate, color };
