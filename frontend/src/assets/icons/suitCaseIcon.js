// icon:bag-suitcase-outline | Material Design Icons https://materialdesignicons.com/ | Austin Andrews
import * as React from "react";

function IconBagSuitcaseOutline(props) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
...
export default IconBagSuitcaseOutline;
