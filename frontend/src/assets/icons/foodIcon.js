// icon:food-drumstick-outline | Material Design Icons https://materialdesignicons.com/ | Austin Andrews
import * as React from "react";

function IconFoodDrumstickOutline(props) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
...
export default IconFoodDrumstickOutline;
